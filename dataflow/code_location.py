...
class CodeLocation(object):
    ...
    def copy(self):
        return CodeLocation(self.block_addr, self.stmt_idx)
    ...
    def __eq__(self, other):
        ...
        """
        if other:
            return self.block_addr == other.block_addr and self.stmt_idx == other.stmt_idx
        return False
    ...
    def __hash__(self):
        ...
        """
        return hash((self.block_addr, self.stmt_idx))
